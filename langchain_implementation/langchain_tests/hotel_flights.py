...
os.environ["OPENAI_API_KEY"] = "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"
...
def agent():
    ...
    #result = agent_executor.call({"plan trip to dallas texas on 7/30 include hotel"})
    return agent_executor

#print(agent().run("plan trip to dallas texas on 7/30"))